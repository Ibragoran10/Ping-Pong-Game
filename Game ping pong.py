...
# keyboard bindings
wind.listen() # tell the window to expcet keyboard input
...
wind.onkeypress(madrab2_down,"Down")
 # main game loop
while True :
    wind.update() # upates the screen everytime the loop run

    # move the ball
    ball.setx(ball.xcor() + ball.dx) # ball starts at 0 and everytime loops run ---> + 0.10 xaxis
    ball.sety(ball.ycor() + ball.dy) # ball starts at 0 and everytime loops run ---> + 0.10 yaxis
